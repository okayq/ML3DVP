...
def load_mnist(root, data_name='mmnist'):
    ...
    file_map = {
        'mmnist': 'moving_mnist/train-images-idx3-ubyte.gz',
...
def load_fixed_set(root, data_name='mmnist'):
    ...
    file_map = {
        'mmnist': 'moving_mnist/mnist_test_seq.npy',
...
def load_data(batch_size, val_batch_size, data_root, num_workers=4, data_name='mmnist',
