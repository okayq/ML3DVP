...
from API.utils import create_loader


class HumanDataset(Dataset):

    def __init__(self, data_root, list_path, image_size=128,
    ...
    def __getitem__(self, idx):
        ...
        # print(item_list, len(item_list), item_list[1])
        begin = int(item_list[1])
        end = begin + self.seq_length * self.step
        # print(begin, end, self.seq_length, self.step)
...
def load_data(batch_size, val_batch_size, data_root, num_workers=4,
              pre_seq_length=4, aft_seq_length=4, in_shape=[4, 3, 128, 128],
    ...
    # print(os.path.join(data_root, 'train.txt'), image_size)
